...
accelerate launch --multi_gpu --config_file=/mnt/data1/prasann/rlhf-exploration/webgpt-llama/default_config.yaml \
    ...
    --reward_model_name=/mnt/data1/prasann/rlhf-exploration/webgpt-llama/models/rewardrandda \
    --adafactor=False \
    ...
    --early_stopping=False --output_dir=checkpoints/wgptrdappov2/ \
    --init_kl_coef=0.01 --steps=1000
