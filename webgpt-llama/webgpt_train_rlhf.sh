...
accelerate launch --multi_gpu --config_file=/home/prasann/Projects/rlhf-exploration/stack-llama/default_config.yaml \
    --num_machines 1  \
    --num_processes 2 \
    /home/prasann/Projects/rlhf-exploration/webgpt-llama/wgpt_lenconstr.py --log_with=wandb \
    ...
    --early_stopping=False --output_dir=checkpoints/lenconstrppo/ \
    --init_kl_coef=0.1 --steps=1000
