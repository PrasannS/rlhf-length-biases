...
# accelerate launch --multi_gpu --config_file=default_config.yaml --main_process_port=29514 \
#     --num_machines 1  \
#     --num_processes 2 \
#     train_rlhf.py --log_with=wandb \
#     --model_name=/u/prasanns/research/rlhf-exploration/models/sft \
#     --dataset_name="apfarmgpt4" \
#     --reward_model_name=/u/prasanns/research/rlhf-exploration/models/rewards/apfnormal \
#     --adafactor=False \
#     --save_freq=25 \
#     --output_max_length=156 --batch_size=32 \
#     --gradient_accumulation_steps=1 \
#     --ppo_epochs=1 --seed=0 --learning_rate=1.4e-5 \
#     --early_stopping=False --output_dir=checkpoints/apfpponorm/ \
