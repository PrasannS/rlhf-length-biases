...
accelerate launch --multi_gpu --config_file=/home/prasann/Projects/rlhf-exploration/rlcd-llama/default_config.yaml \
    --num_machines 1  \
    --num_processes 2 \
    /home/prasann/Projects/rlhf-exploration/rlcd-llama/rlcd_train_rl.py --log_with=wandb \
    --model_name=/home/prasann/Projects/tfr-decoding/apfarm_models/sft10k/ \
    --reward_model_name=/home/prasann/Projects/rlhf-exploration/rlcd-llama/models/helprm7b \
    --adafactor=False \
    --tokenizer_name=/home/prasann/Projects/tfr-decoding/apfarm_models/sft10k/ \
    --save_freq=25 \
