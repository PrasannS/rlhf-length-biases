...
train_dataset = train_dataset.select(range(118000))
...
eval_dataset = eval_dataset.select(range(int(len(train_dataset)*0.02)))
...
output_name = "./checkpoints/rm_da_randonly/"
