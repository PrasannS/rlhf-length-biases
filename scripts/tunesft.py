...
class ScriptArguments:
    ...
    seq_length: Optional[int] = field(default=128, metadata={"help": "the sequence length"})
    ...
    #save_steps: Optional[int] = field(default=1000, metadata={"help": "how often to save"})
    #output_dir: Optional[str] = field(default="checkpoints/sftwiki", metadata={"help": "the split to use"})
